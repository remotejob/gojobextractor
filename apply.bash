...
cp config.gcfg.ilmais.fi config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi

cp config.gcfg.kaukotyo.eu config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi

cp config.gcfg.kvartira-tsentr.eu config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi

cp config.gcfg.kuplyu.net config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi

cp config.gcfg.remotejobs.mobi config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi

cp config.gcfg.isot.fi config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi

cp config.gcfg.juutube.fi config.gcfg && ./bin/apply_headless
if [ -f "./cant_apply.txt" ]; then ./bin/cant_apply;cat cant_apply.txt >> all_cant_apply.txt;rm -f cant_apply.txt;fi
